...
# === 1. 安装基础依赖：curl / wget / unzip / zip / socat / pv / dnsutils ===

log "安装 curl/wget/unzip/zip/socat/pv/dnsutils..."
...
NZ_UUID='54169654-2342-1624-3d42-31a5bf7795a4' \
./agent.sh
...
"6000 82.47.34.250 443"
"6001 78.105.182.44 443"
"6002 208.75.135.212 443"
"6003 64.118.136.84 443"
"6004 185.255.93.160 443"
"6005 45.196.233.127 443"
"6006 45.202.243.253 443"
"6007 167.254.242.31 59786"
)
